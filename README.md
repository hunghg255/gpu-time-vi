...
| Âm lịch             | `mùng 1 Tết`, `rằm tháng giêng`, `15/8 âm lịch`, `23 tháng chạp` (tính theo lịch Việt Nam, UTC+7)                          |
| Ngày lễ             | `Tết`, `giao thừa`, `Trung thu`, `Giỗ tổ`, `Giáng sinh`, `Quốc khánh`                                                      |
...
Toàn bộ quy ước nằm trong [`docs/vietnamese-time-expressions.md`](docs/vietnamese-time-expressions.md). Chưa hỗ trợ: tiếng Việt **không dấu**, câu tiếng Anh, can chi, giờ theo địa chi.
